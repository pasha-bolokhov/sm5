...
{\Large
  \textbf{
  \textsc{Structure of Dimension 5 Lorentz Violating Interactions 
...
% higher dimensional 
	...
	Lorentz invariance.
	The ideas of breaking Lorentz invariance appeared
	...
	presence of background tensors.
	In this direction, most developments consider only a sufficiently limited set
	of LV interactions, the most popular of which are the dimension three
...
%	Standard Model. 
	...
	The main line of this survey is an essentially abstract listing and
	...
	From the phenomenological respect, one can find a strikingly broad 
	...
	[{\it lots of refs}].
	One of the newly proposed directions is the possibility of CPT-odd
...
%	Furthermore, in the aspect of LV effects, 
	In this aspect,
	QED is still one of the most popular testing grounds [].
