...
\end{table}
	...
	\cite{Gagnon:2004xh}. 
	Renormalization group equations (see Appendix \ref{RG_SM}) then spread these limits on other sectors.
	...
	limits.
	Sufficiently strong LV in the up quark sector would allow protons of the cosmic
	...
	For this type interactions the bounds from low-energy precision experiments are applicable.
