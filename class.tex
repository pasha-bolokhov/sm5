...
% higher dimensional 
	...
	and investigate the properties of the resulting models.
...
\]
	...
	three structures which would be CPT-odd and be contracted with a tensor
...
% eighth line
	...
	~.
\end{align*}	
	Here we introduced $ \wt{f}{}_{1,2}^{\mu\nu} \,\equiv\, \frac{1}{2} 
...
\end{equation}
	...
	However, any conceivable electromagnetic field which can be created in the laboratory
	...
	We finally make a remark that our considerations here certainly excluded such 
	operators as $ \ov{\psi}\,\wt{F}^{\mu\nu}\gamma_\mu [\gamma^5] \psi $,
	since in the Standard Model they are not protected from quadratic divergencies.
	We build our model at a high ultraviolate scale, and such divergencies
	bring consistency problems into the theory.
	In particular, we assume our GeV-scale interactions to be expressed in terms
	...
	(to say, if UV scale of the effective theory is appreciably low)
...
\section{Conclusion}
	...
	It has been shown that in QED admits a plenty of interactions,
	...
	phenomenological investigation of such theories.
	...
	However, the accent of this paper was mainly put on the Standard Model 
	domain.
	...
	The field content essentially decreases below the EW scale,
	and so does the LV content.
	Imposing a constraint of absence of uncontrollable divergencies,
	one obtains a theory with a narrower set of LV terms, which 
	...
	At the same time, analysis of the LV operators in the
	Standard Model is directly related to observations and
	experimental constraints.
	In the inverse direction, in more abstract theories, one expects
